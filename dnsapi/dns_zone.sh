...
Site: Zone.eu
Docs: github.com/khulnasoft/protocol.sh/wiki/dnsapi#dns_zone
Options:
 ZONE_Username Username
 ZONE_Key API Key
Issues: github.com/khulnasoft/protocol.sh/issues/2146
'
...
#Usage: dns_zone_add   _protocol-challenge.www.domain.com   "XKrxpRBosdIKFzxW_CT3KLZNf6q0HG9i01zxXp5CPBs"
dns_zone_add() {
  fulldomain=$1
  txtvalue=$2
