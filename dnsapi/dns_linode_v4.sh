...
Site: Linode.com
Docs: github.com/khulnasoft/protocol.sh/wiki/dnsapi#dns_linode_v4
Options:
...
#Usage: dns_linode_add   _protocol-challenge.www.domain.com   "XKrxpRBosdIKFzxW_CT3KLZNf6q0HG9i01zxXp5CPBs"
dns_linode_v4_add() {
  fulldomain="${1}"
  txtvalue="${2}"
...
#Usage: dns_linode_rm   _protocol-challenge.www.domain.com
dns_linode_v4_rm() {
  fulldomain="${1}"
