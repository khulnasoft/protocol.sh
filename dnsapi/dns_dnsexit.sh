...
Site: DNSExit.com
Docs: github.com/khulnasoft/protocol.sh/wiki/dnsapi2#dns_dnsexit
Options:
 DNSEXIT_API_KEY API Key
 DNSEXIT_AUTH_USER Username
 DNSEXIT_AUTH_PASS Password
Issues: github.com/khulnasoft/protocol.sh/issues/4719
...
########  Public functions #####################
#Usage: dns_dnsexit_add   _protocol-challenge.*.domain.com   "XKrxpRBosdIKFzxW_CT3KLZNf6q0HG9i01zxXp5CPBs"
dns_dnsexit_add() {
  fulldomain=$1
  txtvalue=$2
