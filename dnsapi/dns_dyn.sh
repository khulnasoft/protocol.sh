...
Domains: dynect.net
Site: Dyn.com
Docs: github.com/khulnasoft/protocol.sh/wiki/dnsapi#dns_dyn
Options:
...
#Usage: add  _protocol-challenge.www.domain.com   "Challenge-code"
dns_dyn_add() {
  fulldomain="$1"
  txtvalue="$2"
...
#fulldomain=_protocol-challenge.www.domain.com
#returns
