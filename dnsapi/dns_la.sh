...
dns_la_info='dns.la
Site: dns.la
Docs: github.com/khulnasoft/protocol.sh/wiki/dnsapi2#dns_la
Options:
 LA_Id API ID
 LA_Key API key
Issues: github.com/khulnasoft/protocol.sh/issues/4257
'
...
#Usage: dns_la_add  _protocol-challenge.www.domain.com   "XKrxpRBosdIKFzxW_CT3KLZNf6q0HG9i01zxXp5CPBs"
dns_la_add() {
  fulldomain=$1
  txtvalue=$2
