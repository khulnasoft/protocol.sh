...
Site: MyDevil.net
Docs: github.com/khulnasoft/protocol.sh/wiki/dnsapi#dns_mydevil
Issues: github.com/khulnasoft/protocol.sh/issues/2079
Author: Marcin Konicki <https://ahwayakchih.neoni.net>
'

########  Public functions #####################

#Usage: dns_mydevil_add   _protocol-challenge.www.domain.com   "XKrxpRBosdIKFzxW_CT3KLZNf6q0HG9i01zxXp5CPBs"
dns_mydevil_add() {
  fulldomain=$1
  txtvalue=$2
  domain=""
...
# Usage: domain=$(mydevil_get_domain "_protocol-challenge.www.domain.com" || _err "Invalid domain name")
#        echo $domain
mydevil_get_domain() {
  fulldomain=$1
  domain=""
