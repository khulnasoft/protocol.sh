...
Site: DomeneShop.no
Docs: github.com/khulnasoft/protocol.sh/wiki/dnsapi2#dns_domeneshop
Options:
 DOMENESHOP_Token Token
 DOMENESHOP_Secret Secret
Issues: github.com/khulnasoft/protocol.sh/issues/2457
'
...
# Example: dns_domeneshop_add _protocol-challenge.www.domain.com "XKrxpRBosdIKFzxW_CT3KLZNf6q0HG9i01zxXp5CPBs"
dns_domeneshop_add() {
  fulldomain=$1
  txtvalue=$2
...
# Example: dns_domeneshop_rm _protocol-challenge.www.domain.com "XKrxpRBosdIKFzxW_CT3KLZNf6q0HG9i01zxXp5CPBs"
dns_domeneshop_rm() {
  fulldomain=$1
  txtvalue=$2
