...
#
# Pass credentials before "protocol.sh --issue --dns dns_limacity ..."
# --
...
#Usage: dns_limacity_add   _protocol-challenge.www.domain.com   "XKrxpRBosdIKFzxW_CT3KLZNf6q0HG9i01zxXp5CPBs"
dns_limacity_add() {
...
#Usage: dns_limacity_rm   _protocol-challenge.www.domain.com
dns_limacity_rm() {
