...
Site: RackCorp.com
Docs: github.com/khulnasoft/protocol.sh/wiki/dnsapi2#dns_rackcorp
Options:
 RACKCORP_APIUUID API UUID. See Portal: ADMINISTRATION -> API
 RACKCORP_APISECRET API Secret
Issues: github.com/khulnasoft/protocol.sh/issues/3351
...
#_protocol-challenge.domain.com
#returns
# _lookup=_protocol-challenge
# _domain=domain.com
_get_root() {
  domain=$1
  i=1
