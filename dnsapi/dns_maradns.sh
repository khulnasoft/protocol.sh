...
Docs: github.com/khulnasoft/protocol.sh/wiki/dnsapi#dns_maradns
Options:
...
Issues: github.com/khulnasoft/protocol.sh/issues/2072
'

#Usage: dns_maradns_add _protocol-challenge.www.domain.com "token"
dns_maradns_add() {
  fulldomain="$1"
  txtvalue="$2"
...
#Usage: dns_maradns_rm _protocol-challenge.www.domain.com "token"
dns_maradns_rm() {
  fulldomain="$1"
  txtvalue="$2"
