...
Docs: github.com/khulnasoft/protocol.sh/wiki/dnsapi#dns_ali
Options:
 Ali_Key API Key
...
# https://github.com/khulnasoft/protocol.sh/pull/5205#issuecomment-2357867276
...
#Usage: dns_ali_add   _protocol-challenge.www.domain.com   "XKrxpRBosdIKFzxW_CT3KLZNf6q0HG9i01zxXp5CPBs"
dns_ali_add() {
  fulldomain=$1
  txtvalue=$2
