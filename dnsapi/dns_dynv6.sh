...
Site: DynV6.com
Docs: github.com/khulnasoft/protocol.sh/wiki/dnsapi2#dns_dynv6
Options:
 DYNV6_TOKEN REST API token. Get from https://DynV6.com/keys
OptionsAlt:
 KEY Path to SSH private key file. E.g. "/root/.ssh/dynv6"
Issues: github.com/khulnasoft/protocol.sh/issues/2702
Author: StefanAbl
'

dynv6_api="https://dynv6.com/api/v2"
########  Public functions #####################
# Please Read this guide first: https://github.com/Neilpang/protocol.sh/wiki/DNS-API-Dev-Guide
#Usage: dns_dynv6_add  _protocol-challenge.www.domain.com  "XKrxpRBosdIKFzxW_CT3KLZNf6q0HG9i01zxXp5CPBs"
dns_dynv6_add() {
...
# and record ist in the form _protocol.www for an fqdn of _protocol.www.example.com
# returns _record_id
_get_record_id() {
  _zone_id="$1"
  record="$2"
...
#usage: _set_record TXT _protocol_challenge.www longvalue 12345678
...
_set_record() {
  ...
  #data='{ "name": "protocol.test.thorn.dynv6.net", "type": "A", "data": "192.168.0.1"}'
  echo "$data"
