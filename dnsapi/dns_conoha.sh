...
Domains: ConoHa.io
Site: ConoHa.jp
Docs: github.com/khulnasoft/protocol.sh/wiki/dnsapi#dns_conoha
Options:
...
#Usage: dns_conoha_add   _protocol-challenge.www.domain.com   "XKrxpRBosdIKFzxW_CT3KLZNf6q0HG9i01zxXp5CPBs"
dns_conoha_add() {
  fulldomain=$1
  txtvalue=$2
  _info "Using conoha"
