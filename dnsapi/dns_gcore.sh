...
Site: Gcore.com
Docs: github.com/khulnasoft/protocol.sh/wiki/dnsapi#dns_gcore
Options:
 GCORE_Key API Key
Issues: github.com/khulnasoft/protocol.sh/issues/4460
'
...
#_protocol-challenge.sub.domain.com
#returns
# _sub_domain=_protocol-challenge.sub or _protocol-challenge
# _domain=domain.com
