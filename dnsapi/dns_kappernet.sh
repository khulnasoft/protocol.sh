...
Site: kapper.net
Docs: github.com/khulnasoft/protocol.sh/wiki/dnsapi2#dns_kappernet
Options:
 KAPPERNETDNS_Key API Key
 KAPPERNETDNS_Secret API Secret
Issues: github.com/khulnasoft/protocol.sh/issues/2977
'

###############################################################################
# called with
# fullhostname: something.example.com
# txtvalue:     someprotocolgenerated string
dns_kappernet_add() {
  fullhostname=$1
  txtvalue=$2
...
# e.g._protocol-challenge.www.domain.com returns
