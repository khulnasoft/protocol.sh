...
Site: UltraDNS.com
Docs: github.com/khulnasoft/protocol.sh/wiki/dnsapi#dns_ultra
Options:
 ULTRA_USR Username
 ULTRA_PWD Password
Issues: github.com/khulnasoft/protocol.sh/issues/2118
'

ULTRA_API="https://api.ultradns.com/v3/"
ULTRA_AUTH_API="https://api.ultradns.com/v2/"

#Usage: add _protocol-challenge.www.domain.com "some_long_string_of_characters_go_here_from_lets_encrypt"
dns_ultra_add() {
  fulldomain=$1
  txtvalue=$2
  export txtvalue
