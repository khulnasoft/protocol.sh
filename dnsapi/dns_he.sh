...
Site: dns.he.net
Docs: github.com/khulnasoft/protocol.sh/wiki/dnsapi#dns_he
Options:
 HE_Username Username
 HE_Password Password
Issues: github.com/angel333/protocol.sh/issues/
Author: Ondrej Simek <me@ondrejsimek.com>
'

#-- dns_he_add() - Add TXT record --------------------------------------
# Usage: dns_he_add _protocol-challenge.subdomain.domain.com "XyZ123..."
...
# Usage: dns_he_rm _protocol-challenge.subdomain.domain.com "XyZ123..."
