...
Docs: github.com/khulnasoft/protocol.sh/wiki/dnsapi2#dns_mythic_beasts
Options:
 MB_AK API Key
 MB_AS API Secret
Issues: github.com/khulnasoft/protocol.sh/issues/3848
'
# Mythic Beasts is a long-standing UK service provider using standards-based OAuth2 authentication
# To test: ./protocol.sh --dns dns_mythic_beasts --test --debug 1 --output-insecure --issue --domain domain.com
# Cannot retest once cert is issued
# OAuth2 tokens only valid for 300 seconds so we do not store
# NOTE: This will remove all TXT records matching the fulldomain, not just the added ones (_protocol-challenge.www.domain.com)
...
#Usage: rm  _protocol-challenge.www.domain.com   "XKrxpRBosdIKFzxW_CT3KLZNf6q0HG9i01zxXp5CPBs"
...
#Possible formats:
# _protocol-challenge.www.example.com
# _protocol-challenge.example.com
# _protocol-challenge.example.co.uk
# _protocol-challenge.www.example.co.uk
# _protocol-challenge.sub1.sub2.www.example.co.uk
# sub1.sub2.example.co.uk
# example.com
# example.co.uk
#returns
# _sub_domain=_protocol-challenge.www
# _domain=domain.com
_get_root() {
  domain=$1
  i=1
