...
Docs: github.com/khulnasoft/protocol.sh/wiki/dnsapi#dns_nsupdate
Options:
...
#Usage: dns_nsupdate_add   _protocol-challenge.www.domain.com   "XKrxpRBosdIKFzxW_CT3KLZNf6q0HG9i01zxXp5CPBs"
dns_nsupdate_add() {
  fulldomain=$1
  txtvalue=$2
...
#Usage: dns_nsupdate_rm   _protocol-challenge.www.domain.com
dns_nsupdate_rm() {
  fulldomain=$1
