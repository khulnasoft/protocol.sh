...
Site: World4You.com
Docs: github.com/khulnasoft/protocol.sh/wiki/dnsapi#dns_world4you
Options:
 WORLD4YOU_USERNAME Username
 WORLD4YOU_PASSWORD Password
Issues: github.com/khulnasoft/protocol.sh/issues/3269
...
dns_world4you_add() {
  ...
  _resethttp
  export PROTOCOL_HTTP_NO_REDIRECTS=1
