...
Domains: 1984.is
Site: 1984.hosting
Docs: github.com/khulnasoft/protocol.sh/wiki/dnsapi2#dns_1984hosting
Options:
 One984HOSTING_Username Username
 One984HOSTING_Password Password
Issues: github.com/khulnasoft/protocol.sh/issues/2851
Author: Adrian Fedoreanu
'

######## Public functions #####################

# Usage: dns_1984hosting_add   _protocol-challenge.www.domain.com   "XKrxpRBosdIKFzxW_CT3KLZNf6q0HG9i01zxXp5CPBs"
# Add a text record.
dns_1984hosting_add() {
  fulldomain=$1
  txtvalue=$2
  ...
  _info "Added protocol challenge TXT record for $fulldomain at 1984Hosting."
  return 0
}
...
dns_1984hosting_rm() {
  ...
  _info "Deleted protocol challenge TXT record for $fulldomain at 1984Hosting."
  return 0
}
