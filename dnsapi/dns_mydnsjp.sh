...
Site: MyDNS.JP
Docs: github.com/khulnasoft/protocol.sh/wiki/dnsapi#dns_mydnsjp
Options:
...
#Usage: dns_mydnsjp_add   _protocol-challenge.www.domain.com   "XKrxpRBosdIKFzxW_CT3KLZNf6q0HG9i01zxXp5CPBs"
dns_mydnsjp_add() {
  fulldomain=$1
  txtvalue=$2
