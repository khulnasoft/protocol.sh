...
Docs: github.com/khulnasoft/protocol.sh/wiki/dnsapi2#dns_miab
Options:
 MIAB_Username Admin username
 MIAB_Password Admin password
 MIAB_Server Server hostname. FQDN of your_MIAB Server
Issues: github.com/khulnasoft/protocol.sh/issues/2550
Author: Darven Dissek, William Gertz
'

########  Public functions #####################

#Usage: dns_miab_add  _protocol-challenge.www.domain.com  "XKrxpRBosdIKFzxW_CT3KLZNf6q0HG9i01zxXp5CPBs"
dns_miab_add() {
  fulldomain=$1
...
#Usage: dns_miab_rm  _protocol-challenge.www.domain.com   "XKrxpRBosdIKFzxW_CT3KLZNf6q0HG9i01zxXp5CPBs"
dns_miab_rm() {
  fulldomain=$1
  txtvalue=$2
...
#
#Usage: _get_root  _protocol-challenge.www.domain.com
#Returns:
...
#Useage: _miab_rest  "XKrxpRBosdIKFzxW_CT3KLZNf6q0HG9i01zxXp5CPBs"  "custom/_protocol-challenge.www.domain.com/txt  "POST"
