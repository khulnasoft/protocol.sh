...
Docs: github.com/khulnasoft/protocol.sh/wiki/dnsapi#dns_gcloud
Options:
...
# Usage: dns_gcloud_add   _protocol-challenge.www.domain.com   "XKrxpRBosdIKFzxW_CT3KLZNf6q0HG9i01zxXp5CPBs"
dns_gcloud_add() {
  fulldomain=$1
  txtvalue=$2
  _info "Using gcloud"
...
# Usage: dns_gcloud_rm   _protocol-challenge.www.domain.com   "XKrxpRBosdIKFzxW_CT3KLZNf6q0HG9i01zxXp5CPBs"
...
_dns_gcloud_find_zone() {
  ...
  # For example, _protocol-challenge.something.domain.com might need to go into something.domain.com or domain.com;
