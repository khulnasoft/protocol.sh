...
Site: Fornex.com
Docs: github.com/khulnasoft/protocol.sh/wiki/dnsapi2#dns_fornex
Options:
 FORNEX_API_KEY API Key
Issues: github.com/khulnasoft/protocol.sh/issues/3998
...
#Usage: dns_fornex_add   _protocol-challenge.www.domain.com   "XKrxpRBosdIKFzxW_CT3KLZNf6q0HG9i01zxXp5CPBs"
dns_fornex_add() {
  fulldomain=$1
  txtvalue=$2
...
#Usage: dns_fornex_rm   _protocol-challenge.www.domain.com
dns_fornex_rm() {
  fulldomain=$1
  txtvalue=$2
