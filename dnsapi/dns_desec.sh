...
Docs: github.com/khulnasoft/protocol.sh/wiki/dnsapi#dns_desec
Options:
 DDNSS_Token API Token
Issues: github.com/khulnasoft/protocol.sh/issues/2180
Author: Zheng Qian
'
...
#Usage: dns_desec_add   _protocol-challenge.foobar.dedyn.io   "d41d8cd98f00b204e9800998ecf8427e"
dns_desec_add() {
  fulldomain=$1
  txtvalue=$2
