...
Site: Netlify.com
Docs: github.com/khulnasoft/protocol.sh/wiki/dnsapi2#dns_netlify
Options:
 NETLIFY_ACCESS_TOKEN API Token
Issues: github.com/khulnasoft/protocol.sh/issues/3088
'
...
#Usage: dns_myapi_rm   _protocol-challenge.www.domain.com   "XKrxpRBosdIKFzxW_CT3KLZNf6q0HG9i01zxXp5CPBs"
