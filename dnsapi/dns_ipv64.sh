...
Site: IPv64.net
Docs: github.com/khulnasoft/protocol.sh/wiki/dnsapi2#dns_ipv64
Options:
 IPv64_Token API Token
Issues: github.com/khulnasoft/protocol.sh/issues/4419
...
#Usage: dns_ipv64_add _protocol-challenge.domain.ipv64.net "XKrxpRBosdIKFzxW_CT3KLZNf6q0HG9i01zxXp5CPBs"
dns_ipv64_add() {
  fulldomain=$1
  txtvalue=$2
...
#Usage: dns_ipv64_rm _protocol-challenge.domain.ipv64.net "XKrxpRBosdIKFzxW_CT3KLZNf6q0HG9i01zxXp5CPBs"
