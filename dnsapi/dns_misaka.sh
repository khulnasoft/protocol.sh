...
Site: Misaka.io
Docs: github.com/khulnasoft/protocol.sh/wiki/dnsapi2#dns_misaka
Options:
 Misaka_Key API Key
Author: <support+khulnasoft@misaka.io>
'
...
_misaka_rest() {
  ...
  export _H2="User-Agent: protocol.sh/$VER misaka-dns-khulnasoft/20191213"
