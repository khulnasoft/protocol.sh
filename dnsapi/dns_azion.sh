...
Site: Azion.com
Docs: github.com/khulnasoft/protocol.sh/wiki/dnsapi2#dns_azion
Options:
 AZION_Email Email
 AZION_Password Password
Issues: github.com/khulnasoft/protocol.sh/issues/3555
'
...
# Usage: _protocol-challenge.www.domain.com
# returns
