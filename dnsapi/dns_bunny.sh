...
Site: Bunny.net/dns/
Docs: github.com/khulnasoft/protocol.sh/wiki/dnsapi2#dns_bunny
Options:
 BUNNY_API_KEY API Key
Issues: github.com/khulnasoft/protocol.sh/issues/4296
...
## EG: "_protocol-challenge.www.other.domain.com" "XKrxpRBosdq0HG9i01zxXp5CPBs"
dns_bunny_add() {
...
## USAGE: fulldomain
## EG: "_protocol-challenge.two.three.four.domain.com"
## returns
## _sub_domain="_protocol-challenge.two"
## _domain="three.four.domain.com" *IF* zone "three.four.domain.com" exists
## _domain_id=234
## if only "domain.com" exists it will return
## _sub_domain="_protocol-challenge.two.three.four"
## _domain="domain.com"
## _domain_id=234
_get_base_domain() {
  # args
