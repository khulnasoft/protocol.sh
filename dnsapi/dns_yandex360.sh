...
Docs: https://github.com/khulnasoft/protocol.sh/wiki/dnsapi2#dns_yandex360
Options:
...
Issues: https://github.com/khulnasoft/protocol.sh/issues/5213
...
_check_variables() {
  ...
  if [ -n "$YANDEX360_ACCESS_TOKEN" ]; then
    ...
    _info 'It is recommended to obtain the token interactively using protocol.sh for one-time setup.'
    _info 'Subsequent token renewals will be handled automatically.'
    _info 'For more details, please visit: https://github.com/khulnasoft/protocol.sh/wiki/dnsapi2#dns_yandex360'
    _info '========================================='
    ...
    _err 'For more details, please visit: https://github.com/khulnasoft/protocol.sh/wiki/dnsapi2#dns_yandex360'
    _err '========================================='
    return 1
...
_get_token() {
  ...
  hostname=$(uname -n)
  data="client_id=$YANDEX360_CLIENT_ID&device_id=protocol.sh ${hostname}&device_name=protocol.sh ${hostname}"
