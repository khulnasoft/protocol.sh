...
Site: OVH.com
Docs: github.com/khulnasoft/protocol.sh/wiki/How-to-use-OVH-domain-api
Options:
...
wiki="https://github.com/khulnasoft/protocol.sh/wiki/How-to-use-OVH-domain-api"

ovh_success="https://github.com/khulnasoft/protocol.sh/wiki/OVH-Success"
