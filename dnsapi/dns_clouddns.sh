...
Docs: github.com/khulnasoft/protocol.sh/wiki/dnsapi2#dns_clouddns
Options:
 CLOUDDNS_EMAIL Email
 CLOUDDNS_PASSWORD Password
 CLOUDDNS_CLIENT_ID Client ID
Issues: github.com/khulnasoft/protocol.sh/issues/2699
...
# Usage: rm _protocol-challenge.www.domain.com
dns_clouddns_rm() {
  fulldomain=$1
  _debug "fulldomain" "$fulldomain"
