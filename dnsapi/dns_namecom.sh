...
Site: Name.com
Docs: github.com/khulnasoft/protocol.sh/wiki/dnsapi#dns_namecom
Options:
...
#Usage: dns_namecom_add   _protocol-challenge.www.domain.com   "XKrxpRBosdIKFzxW_CT3KLZNf6q0HG9i01zxXp5CPBs"
dns_namecom_add() {
  fulldomain=$1
  txtvalue=$2
