...
Site: DDNSS.de
Docs: github.com/khulnasoft/protocol.sh/wiki/dnsapi#dns_ddnss
Options:
 DDNSS_Token API Token
Issues: github.com/khulnasoft/protocol.sh/issues/2230
...
#Usage: dns_ddnss_add _protocol-challenge.domain.ddnss.de "XKrxpRBosdIKFzxW_CT3KLZNf6q0HG9i01zxXp5CPBs"
dns_ddnss_add() {
  fulldomain=$1
  txtvalue=$2
...
#fulldomain=_protocol-challenge.domain.ddnss.de
#returns
