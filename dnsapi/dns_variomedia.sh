...
Site: variomedia.de
Docs: github.com/khulnasoft/protocol.sh/wiki/dnsapi#dns_variomedia
Options:
 VARIOMEDIA_API_TOKEN API Token
Issues: github.com/khulnasoft/protocol.sh/issues/2564
'
...
dns_variomedia_rm() {
  ...
  if [ "$_record_id" ]; then
    _info "Successfully retrieved the record id for PROTOCOL challenge."
  else
