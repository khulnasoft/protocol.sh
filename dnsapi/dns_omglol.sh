...
Domains: omg.lol
Site: github.com/khulnasoft/protocol.sh/wiki/DNS-API-Dev-Guide
Docs: github.com/khulnasoft/protocol.sh/wiki/dnsapi#dns_duckdns
Options:
...
Issues: github.com/khulnasoft/protocol.sh
Author: @Kholin <kholin+protocol.omglolapi@omg.lol>
'
...
# Please Read this guide first: https://github.com/khulnasoft/protocol.sh/wiki/DNS-API-Dev-Guide
...
# Add (or modify) an entry for a new PROTOCOL query
omg_add() {
  address=$1
  authHeader=$2
  dnsName=$3
