...
Docs: github.com/khulnasoft/protocol.sh/wiki/dnsapi2#dns_openstack
Options:
...
Issues: github.com/khulnasoft/protocol.sh/issues/3054
Author: Andy Botting <andy@andybotting.com>
'

########  Public functions #####################

# Usage: dns_openstack_add   _protocol-challenge.www.domain.com   "XKrxpRBosdIKFzxW_CT3KLZNf6q0HG9i01zxXp5CPBs"
dns_openstack_add() {
  fulldomain=$1
  txtvalue=$2
...
# Usage: dns_openstack_rm   _protocol-challenge.www.domain.com   "XKrxpRBosdIKFzxW_CT3KLZNf6q0HG9i01zxXp5CPBs"
...
_dns_openstack_get_root() {
  ...
  # match. For example, _protocol-challenge.something.domain.com might need to go
