...
Site: Joker.com
Docs: github.com/khulnasoft/protocol.sh/wiki/dnsapi2#dns_joker
Options:
 JOKER_USERNAME Username
 JOKER_PASSWORD Password
Issues: github.com/khulnasoft/protocol.sh/issues/2840
...
#Usage: dns_joker_add  _protocol-challenge.www.domain.com   "XKrxpRBosdIKFzxW_CT3KLZNf6q0HG9i01zxXp5CPBs"
dns_joker_add() {
  fulldomain=$1
  txtvalue=$2
