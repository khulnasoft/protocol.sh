...
Site: NameCheap.com
Docs: github.com/khulnasoft/protocol.sh/wiki/dnsapi#dns_namecheap
Options:
 NAMECHEAP_API_KEY API Key
 NAMECHEAP_USERNAME Username
 NAMECHEAP_SOURCEIP Source IP
Issues: github.com/khulnasoft/protocol.sh/issues/2107
'
...
#Usage: dns_namecheap_add   _protocol-challenge.www.domain.com   "XKrxpRBosdIKFzxW_CT3KLZNf6q0HG9i01zxXp5CPBs"
dns_namecheap_add() {
  fulldomain=$1
  txtvalue=$2
