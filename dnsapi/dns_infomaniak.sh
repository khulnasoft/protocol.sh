...
Site: Infomaniak.com
Docs: github.com/khulnasoft/protocol.sh/wiki/dnsapi2#dns_infomaniak
Options:
 INFOMANIAK_API_TOKEN API Token
Issues: github.com/khulnasoft/protocol.sh/issues/3188
'
...
#Usage: dns_infomaniak_add   _protocol-challenge.www.domain.com   "XKrxpRBosdIKFzxW_CT3KLZNf6q0HG9i01zxXp5CPBs"
dns_infomaniak_add() {
  ...
  fqdn=${fulldomain#_protocol-challenge.}
