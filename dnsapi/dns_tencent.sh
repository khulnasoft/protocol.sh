...
Docs: github.com/khulnasoft/protocol.sh/wiki/dnsapi#dns_tencent
Options:
 Tencent_SecretId Secret ID
 Tencent_SecretKey Secret Key
Issues: github.com/khulnasoft/protocol.sh/issues/4781
'
Tencent_API="https://dnspod.tencentcloudapi.com"

#Usage: dns_tencent_add   _protocol-challenge.www.domain.com   "XKrxpRBosdIKFzxW_CT3KLZNf6q0HG9i01zxXp5CPBs"
dns_tencent_add() {
  fulldomain=$1
  txtvalue=$2
