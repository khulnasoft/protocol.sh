...
Docs: github.com/khulnasoft/protocol.sh/wiki/dnsapi#dns_gandi_livedns
Options:
 GANDI_LIVEDNS_KEY API Key
Issues: github.com/fcrozat/protocol.sh
...
#Usage: dns_gandi_livedns_add   _protocol-challenge.www.domain.com   "XKrxpRBosdIKFzxW_CT3KLZNf6q0HG9i01zxXp5CPBs"
...
_dns_gandi_existing_rrset_values() {
  ...
  if ! _contains "$response" '"rrset_type":"TXT"'; then
    _debug "Does not have a _protocol-challenge TXT record yet."
    return 1
  fi
