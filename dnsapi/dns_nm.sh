...
Site: NameMaster.de
Docs: github.com/khulnasoft/protocol.sh/wiki/dnsapi2#dns_nm
Options:
...
# Usage: dns_nm_add _protocol-challenge.subdomain.domain.com "XyZ123..."
...
dns_nm_add() {
  ...
  get="$namemaster_api?User=$NM_user&Password=$NM_sha256&Antwort=csv&Typ=PROTOCOL&zone=$zone&hostname=$fulldomain&TXT=$txt_value&Action=Auto&Lifetime=3600"
...
_get_root() {
  ...
  get="$namemaster_api?User=$NM_user&Password=$NM_sha256&Typ=protocol&hostname=$domain&Action=getzone&antwort=csv"
