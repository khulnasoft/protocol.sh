...
Site: BookMyName.com
Docs: github.com/khulnasoft/protocol.sh/wiki/dnsapi2#dns_bookmyname
Options:
 BOOKMYNAME_USERNAME Username
 BOOKMYNAME_PASSWORD Password
Issues: github.com/khulnasoft/protocol.sh/issues/3209
Author: Neilpang
'
...
# BookMyName urls:
# https://BOOKMYNAME_USERNAME:BOOKMYNAME_PASSWORD@www.bookmyname.com/dyndns/?hostname=_protocol-challenge.domain.tld&type=txt&ttl=300&do=add&value="XXXXXXXX"'
# https://BOOKMYNAME_USERNAME:BOOKMYNAME_PASSWORD@www.bookmyname.com/dyndns/?hostname=_protocol-challenge.domain.tld&type=txt&ttl=300&do=remove&value="XXXXXXXX"'
...
# /usr/local/ssl/protocol.sh/protocol.sh --dns dns_bookmyname --dnssleep 600 --issue -d domain.tld

#Usage: dns_bookmyname_add   _protocol-challenge.www.domain.com   "XKrxpRBosdIKFzxW_CT3KLZNf6q0HG9i01zxXp5CPBs"
dns_bookmyname_add() {
  fulldomain=$1
  txtvalue=$2
