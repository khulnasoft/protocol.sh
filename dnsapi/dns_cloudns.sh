...
Site: ClouDNS.net
Docs: github.com/khulnasoft/protocol.sh/wiki/dnsapi#dns_cloudns
Options:
...
#Usage: dns_cloudns_add   _protocol-challenge.www.domain.com   "XKrxpRBosdIKFzxW_CT3KLZNf6q0HG9i01zxXp5CPBs"
dns_cloudns_add() {
  _info "Using cloudns"
...
#Usage: dns_cloudns_rm   _protocol-challenge.www.domain.com   "XKrxpRBosdIKFzxW_CT3KLZNf6q0HG9i01zxXp5CPBs"
dns_cloudns_rm() {
  _info "Using cloudns"
