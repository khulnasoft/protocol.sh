...
Site: RackSpace.com
Docs: github.com/khulnasoft/protocol.sh/wiki/dnsapi#dns_rackspace
Options:
 RACKSPACE_Apikey API Key
 RACKSPACE_Username Username
Issues: github.com/khulnasoft/protocol.sh/issues/2091
'
...
# Original - tcocca:rackspace_dnsapi https://github.com/khulnasoft/protocol.sh/pull/1297
