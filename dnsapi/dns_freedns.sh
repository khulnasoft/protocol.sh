...
Docs: github.com/khulnasoft/protocol.sh/wiki/dnsapi#dns_freedns
Options:
 FREEDNS_User Username
 FREEDNS_Password Password
Issues: github.com/khulnasoft/protocol.sh/issues/2305
...
#  FREEDNS_User=username
#  FREEDNS_Password=password
# login cookie is saved in protocol account config file so userid / pw
# need to be set only when changed.

#Usage: dns_freedns_add   _protocol-challenge.www.domain.com   "XKrxpRBosdIKFzxW_CT3KLZNf6q0HG9i01zxXp5CPBs"
dns_freedns_add() {
  fulldomain="$1"
  txtvalue="$2"
...
_freedns_add_txt_record() {
  ...
  _debug3 "htmlpage: $htmlpage"
  _info "Added protocol challenge TXT record for $fulldomain at FreeDNS"
  return 0
}
...
_freedns_delete_txt_record() {
  ...
  _info "Deleted protocol challenge TXT record for $fulldomain at FreeDNS"
  return 0
}
