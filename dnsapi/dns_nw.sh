...
Site: Nexcess.net
Docs: github.com/khulnasoft/protocol.sh/wiki/dnsapi#dns_nw
Options:
 NW_API_TOKEN API Token
 NW_API_ENDPOINT API Endpoint. Default: "https://portal.nexcess.net".
Issues: github.com/khulnasoft/protocol.sh/issues/2088
...
# Usage: dns_nw_add _protocol-challenge.subdomain.domain.com "XyZ123..."
dns_nw_add() {
  host="${1}"
  txtvalue="${2}"
...
# Usage: dns_nw_rm _protocol-challenge.subdomain.domain.com "XyZ123..."
dns_nw_rm() {
  host="${1}"
  txtvalue="${2}"
...
_rest() {
  ...
  export _H4="User-Agent: NW-PROTOCOL-CLIENT"
