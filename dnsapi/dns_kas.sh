...
Docs: github.com/khulnasoft/protocol.sh/wiki/dnsapi2#dns_kas
Options:
 KAS_Login API login name
 KAS_Authtype API auth type. Default: "plain"
 KAS_Authdata API auth data
Issues: github.com/khulnasoft/protocol.sh/issues/2715
...
# See: https://github.com/Neilpang/protocol.sh/wiki/DNS-API-Dev-Guide
