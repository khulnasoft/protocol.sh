...
Site: GeoScaling.com
Docs: github.com/khulnasoft/protocol.sh/wiki/dnsapi#dns_geoscaling
Options:
...
# Usage: dns_geoscaling_add _protocol-challenge.subdomain.domain.com "XyZ123..."
...
# Usage: dns_geoscaling_rm _protocol-challenge.subdomain.domain.com "XyZ123..."
