...
Docs: github.com/khulnasoft/protocol.sh/wiki/dnsapi2#dns_googledomains
Options:
 GOOGLEDOMAINS_ACCESS_TOKEN API Access Token
 GOOGLEDOMAINS_ZONE Zone
Issues: github.com/khulnasoft/protocol.sh/issues/4545
Author: Alex Leigh <leigh@alexleigh.me>
'

GOOGLEDOMAINS_API="https://protocoldns.googleapis.com/v1/protocolChallengeSets"

######## Public functions ########

#Usage: dns_googledomains_add   _protocol-challenge.www.domain.com   "XKrxpRBosdIKFzxW_CT3KLZNf6q0HG9i01zxXp5CPBs"
dns_googledomains_add() {
  fulldomain=$1
  txtvalue=$2

  _info "Invoking Google Domains PROTOCOL DNS API."
...
#Usage: dns_googledomains_rm   _protocol-challenge.www.domain.com   "XKrxpRBosdIKFzxW_CT3KLZNf6q0HG9i01zxXp5CPBs"
...
_dns_googledomains_setup() {
  ...
  if [ -z "$GOOGLEDOMAINS_ACCESS_TOKEN" ]; then
    ...
    _err "Please visit Google Domains Security settings to provision an PROTOCOL DNS API access token."
    return 1
  fi
