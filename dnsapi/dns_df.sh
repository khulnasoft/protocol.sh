...
Domains: dynup.de
Site: DynDnsFree.de
Docs: github.com/khulnasoft/protocol.sh/wiki/dnsapi2#dns_df
Options:
 DF_user Username
 DF_password Password
Issues: github.com/khulnasoft/protocol.sh/issues/2897
Author: Thilo Gass <thilo.gass@gmail.com>
'

dyndnsfree_api="https://dynup.de/protocol.php"
